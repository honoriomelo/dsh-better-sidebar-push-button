      ...
      fetchActiveRoot(ctx)
        .then(function (resolved) {
          ...
          return postJson(PUSH_PATH, {
            ...
            // OPTIMISTIC CLEAR: the push succeeded — zero the badge and
            // disable the button right now, without waiting for the
            // /check round-trip. Without this, a stale in-flight check
            // (started by the 3s poll before the push finished) can
            // re-apply ahead=N and the badge never clears.
