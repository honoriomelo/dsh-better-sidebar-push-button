      ...
      IN_FLIGHT_CHECK = fetchActiveRoot(ctx)
        .then(function (resolved) {
          ...
          return postJson(CHECK_PATH, {
            ...
            console.log('[BSPB-DIAG]', 'CHECK response ahead=', body.value && body.value.ahead, 'branch=', body.value && body.value.branch, 'upstream=', body.value && body.value.upstream, 'canPush=', body.value && body.value.canPush);
